...
const [bessie = "cow", , dolly = "sheep", babe = "pig", little = "chicken"] = ["cow", "horse", "sheep", "pig", "chicken"];

// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
const [blackAndWhite, , black, pink, ...restColors] = ["cow", "horse", "sheep", "pig", "chicken"];
...
const { job: nestedJob, partner: nestedPartner } = nestedProps;